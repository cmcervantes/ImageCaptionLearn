 ...
 * showcase the data.
 * 
 * TODO: This whole thing needs to be reworked to use Documents better
 * 
 * @author ccervantes
 */
public class HtmlScribe
{
                                         ...
                                         String imgID_prev, String imgID_next)
    {
        ...
        pageBuilder.append("action=\"http://web.engr.illinois.edu/~ccervan2/coref/ex/");
	...
	private static String getColorCodedCaptions(Document d, Set<Chain> chainSet)
	{
        ...
        for(Chain c : chainSet) {
            ...
            //if this was a multi-phrase chain, addScore the color
            if(!isSingletonChain)
                colorIndex++;
        }
